# Laboratorio Esercizi Python

Questa repository raccoglie gli esercizi del corso base di Python.

## ⚠️ Nota sul materiale (Work in Progress)
Tutto il codice presente in questo repository viene prodotto **durante le ore di lezione**. Gli script derivano da:
* ✍️ Esercitazioni pratiche in tempo reale.
